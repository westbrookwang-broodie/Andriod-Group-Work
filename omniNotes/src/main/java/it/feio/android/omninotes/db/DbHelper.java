...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String KEY_REMIND_LATITUDE = "remind_latitude";
    public static final String KEY_REMIND_LONGITUDE = "remind_longitude";
    ...
    public Note updateNote(Note note, boolean updateLastModification) {
        ...
        values.put(KEY_REMIND_LATITUDE, note.getRemind_latitude());
        values.put(KEY_REMIND_LONGITUDE, note.getRemind_longitude());
        ...
        try (Cursor cursor = getDatabase().rawQuery(query, null)) {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    note.setRemind_latitude(cursor.getString(i++));
                    note.setRemind_longitude(cursor.getString(i++));
